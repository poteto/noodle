...
- [1. Redundant State for Derived Values](#1-redundant-state-for-derived-values)
- [2. Filtering/Transforming Data in Effect](#2-filteringtransforming-data-in-effect)
- [3. Resetting State on Prop Change](#3-resetting-state-on-prop-change)
- [4. Event-Specific Logic in Effect](#4-event-specific-logic-in-effect)
- [5. Chains of Effects](#5-chains-of-effects)
- [6. Notifying Parent via Effect](#6-notifying-parent-via-effect)
- [7. Passing Data Up to Parent](#7-passing-data-up-to-parent)
- [8. Fetching Without Cleanup (Race Condition)](#8-fetching-without-cleanup-race-condition)
- [9. App Initialization in Effect](#9-app-initialization-in-effect)
