...
func TestCancelSupersededActiveCooksCancelsChangedStage(t *testing.T) {
	...
	orders := OrdersFile{
		Orders: []Order{{
			...
			Stages: []Stage{
				{TaskKey: "execute", Prompt: "new prompt", Provider: "codex", Model: "gpt-5.3-codex", Status: StageStatusPending},
...
func TestCancelSupersededActiveCooksKeepsMatchingStage(t *testing.T) {
	...
	orders := OrdersFile{
		Orders: []Order{{
			...
			Status: OrderStatusActive,
			Stages: []Stage{
				{TaskKey: "execute", Prompt: "steady prompt", Provider: "codex", Model: "gpt-5.3-codex", Status: StageStatusPending},
				{TaskKey: "adversarial-review", Provider: "claude", Model: "claude-opus-4-6", Status: StageStatusPending},
			},
		}},
	}
