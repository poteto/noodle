...
export function ReviewCard({ item }: { item: PendingReviewItem }) {
  return (
    <div className="bg-bg-1 border-2 border-border p-[18px] cursor-pointer shadow-card transition-[transform,box-shadow] duration-150 ease-out hover:-translate-x-0.5 hover:-translate-y-1 hover:shadow-card-hover">
