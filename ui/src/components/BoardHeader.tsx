  ...
  return (
    <div className="flex items-center justify-between px-10 pt-7 pb-[22px] border-b-3 border-border bg-bg-0 shrink-0">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button className="flex items-center gap-1.5 px-6 py-2 bg-border text-bg-0 font-display text-[0.9375rem] font-700 tracking-[0.04em] border-2 border-border shadow-btn cursor-pointer transition-[transform,box-shadow] duration-[0.12s] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-btn-hover active:translate-x-px active:translate-y-px active:shadow-btn-active" onClick={onNewTask}>
          + new task
        </button>
      </div>
    </div>
