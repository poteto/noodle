    ...
    <div className="flex-1 min-w-[280px] max-w-[380px] flex flex-col max-h-full">
      <div className="border-t-5 border-border bg-bg-2 shrink-0 pb-3">
        <div className="flex items-center justify-between pt-2.5">
          <span className="font-display font-extrabold text-[1.75rem] tracking-[-0.01em] text-text-0">{title}</span>
          <div className="flex items-center gap-2">
            {headerExtra}
            <span className="font-mono text-[0.8125rem] font-bold px-2.5 py-0.5 bg-accent text-bg-0">{count}</span>
          </div>
        </div>
      </div>
