...
28. [ ] Rename `prioritize` skill/task type to `schedule` -- IN PROGRESS. Rename skill directory, frontmatter, all references in loop, mise, config, tests, docs, and brain. [[plans/28-rename-prioritize-to-schedule/overview]]
