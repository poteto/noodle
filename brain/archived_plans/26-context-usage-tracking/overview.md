...
1. [[archived_plans/26-context-usage-tracking/phase-01-extend-canonical-events-with-context-metrics]]
2. [[archived_plans/26-context-usage-tracking/phase-02-enrich-session-metadata-with-context-fields]]
3. [[archived_plans/26-context-usage-tracking/phase-03-add-skill-attribution-to-canonical-events]]
4. [[archived_plans/26-context-usage-tracking/phase-04-surface-context-metrics-in-mise-json]]
5. [[archived_plans/26-context-usage-tracking/phase-05-add-context-efficiency-to-quality-skill]]
6. [[archived_plans/26-context-usage-tracking/phase-06-add-context-audit-to-meditate-skill]]
7. [[archived_plans/26-context-usage-tracking/phase-07-surface-context-metrics-in-tui]]
