...
1. ~~[[archive/plans/49-work-orders-redesign/phase-01-subtract-go-logic]]~~ ✓ `36629cb`
2. ~~[[archive/plans/49-work-orders-redesign/phase-02-define-order-and-stage-types]]~~ ✓ `a872fd2`
3. ~~[[archive/plans/49-work-orders-redesign/phase-03-orders-file-i-o]]~~ ✓ `f612914`
4. ~~[[archive/plans/49-work-orders-redesign/phase-04-stage-lifecycle-functions]]~~ ✓ `f05194c`
5. ~~[[archive/plans/49-work-orders-redesign/phase-05-loop-core-migration]]~~ ✓ `f3bc053`
6. ~~[[archive/plans/49-work-orders-redesign/phase-06-control-commands-and-failed-targets]]~~ ✓ `d81b531`
7. ~~[[archive/plans/49-work-orders-redesign/phase-07-schedule-handling-and-skill-contract]]~~ ✓ `dc2303b`
8. ~~[[archive/plans/49-work-orders-redesign/phase-08-snapshot-and-api]]~~ ✓ `f261e11`
9. ~~[[archive/plans/49-work-orders-redesign/phase-09-web-ui]]~~ ✓ `5c055de`
10. ~~[[archive/plans/49-work-orders-redesign/phase-10-test-migration-and-cleanup]]~~ ✓
...
5. ~~**Codex review**~~ ✓ done — Three independent reviews. 1 critical, 5 high, 5 medium, 3 low findings. See [[archive/plans/49-work-orders-redesign/codex-review-findings]].
