...
1. [[archive/plans/23-task-type-skill-suite/phase-01-dynamic-task-registry]] — Replace hardcoded Go registry with frontmatter-based discovery
2. [[archive/plans/23-task-type-skill-suite/phase-02-native-planning]] — Remove plan adapter, minimal Go reader + CLI commands
3. [[archive/plans/23-task-type-skill-suite/phase-03-context-injection]] — Rename spawner→dispatcher, runtime command dispatch, context preamble

### Task-type skills

4. [[archive/plans/23-task-type-skill-suite/phase-04-prioritize]] — Queue scheduler with plans-as-precondition and schedule reading
5. [[archive/plans/23-task-type-skill-suite/phase-05-quality]] — Post-cook quality gate with verdict files
6. [[archive/plans/23-task-type-skill-suite/phase-06-execute]] — Implementation methodology (worktrees, delegation, verification)
7. [[archive/plans/23-task-type-skill-suite/phase-07-reflect]] — Learning capture from mistakes and corrections
8. [[archive/plans/23-task-type-skill-suite/phase-08-meditate]] — Brain cleanup and principle extraction
9. [[archive/plans/23-task-type-skill-suite/phase-09-oops]] — Infrastructure fix (user-project and Noodle-internal)
10. [[archive/plans/23-task-type-skill-suite/phase-10-debate]] — Structured debate with per-task state

### Skills + cleanup

11. [[phase-11-utility-skills]] — Debugging amendments + plan skill update
12. [[archive/plans/23-task-type-skill-suite/phase-12-cleanup]] — Stale references, delete old skills
