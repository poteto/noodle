...
1. [[archive/plans/73-testing-strategy/phase-01-typesafe-api-boundary]] — Generate TS types from Go structs, delete hand-maintained types
2. [[archive/plans/73-testing-strategy/phase-02-ui-unit-test-infrastructure]] — Install Vitest + Testing Library, configure, write first tests (depends on phase 1)
3. [[archive/plans/73-testing-strategy/phase-03-ui-component-tests]] — Test critical component logic (Board, cards, data layer, SSE)
4. [[archive/plans/73-testing-strategy/phase-04-expand-go-fixture-coverage]] — New fixtures for snapshot builder and loop edge cases
5. [[archive/plans/73-testing-strategy/phase-05-e2e-agent-smoke-test]] — Real Codex agent smoke test with milestone polling
