...
1. [[archive/plans/26-context-usage-tracking/phase-01-extend-canonical-events-with-context-metrics]]
2. [[archive/plans/26-context-usage-tracking/phase-02-enrich-session-metadata-with-context-fields]]
3. [[archive/plans/26-context-usage-tracking/phase-03-add-skill-attribution-to-canonical-events]]
4. [[archive/plans/26-context-usage-tracking/phase-04-surface-context-metrics-in-mise-json]]
5. [[archive/plans/26-context-usage-tracking/phase-05-add-context-efficiency-to-quality-skill]]
6. [[archive/plans/26-context-usage-tracking/phase-06-add-context-audit-to-meditate-skill]]
7. [[archive/plans/26-context-usage-tracking/phase-07-surface-context-metrics-in-tui]]
