...
- [[archive/plans/42-requires-approval-gate/phase-01-frontmatter-spec-permissions-object]]
- [[archive/plans/42-requires-approval-gate/phase-02-remove-hardcoded-quality-from-loop]]
- [[archive/plans/42-requires-approval-gate/phase-03-remove-hardcoded-quality-from-tui]]
- [[archive/plans/42-requires-approval-gate/phase-04-simplify-autonomy-config]]
- [[archive/plans/42-requires-approval-gate/phase-05-request-changes-control-command]]
- [[archive/plans/42-requires-approval-gate/phase-06-reviews-tab-and-approval-flow]]
- [[archive/plans/42-requires-approval-gate/phase-07-update-noodle-skill-with-permissions-docs]]
