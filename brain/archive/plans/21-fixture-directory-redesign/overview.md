...
- [x] [[archive/plans/21-fixture-directory-redesign/phase-01-scaffold]] — Scaffold
- [x] [[archive/plans/21-fixture-directory-redesign/phase-02-fixture-directory-contract-and-loader]] — Fixture Directory Contract and Loader
- [x] [[archive/plans/21-fixture-directory-redesign/phase-03-metadata-and-assertion-contract]] — Metadata and Assertion Contract
- [x] [[archive/plans/21-fixture-directory-redesign/phase-04-parse-adapter-stamp-migration]] — Parse Adapter Stamp Migration
- [x] [[archive/plans/21-fixture-directory-redesign/phase-05-event-monitor-spawner-migration]] — Event Monitor Spawner Migration
- [x] [[archive/plans/21-fixture-directory-redesign/phase-06-loop-state-snapshot-model]] — Loop State Snapshot Model
- [x] [[archive/plans/21-fixture-directory-redesign/phase-07-loop-fixture-migration]] — Loop Fixture Migration
- [x] [[archive/plans/21-fixture-directory-redesign/phase-08-fixture-validator-and-tooling]] — Fixture Validator and Tooling
- [x] [[archive/plans/21-fixture-directory-redesign/phase-09-cleanup-and-final-verification]] — Cleanup and Final Verification
