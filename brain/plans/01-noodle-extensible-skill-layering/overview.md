...
1. [[plans/01-noodle-extensible-skill-layering/phase-01-scaffold]] — Project scaffold + core types
2. [[plans/01-noodle-extensible-skill-layering/phase-02-config]] — Config system
3. [[plans/01-noodle-extensible-skill-layering/phase-03-skill-resolver]] — Skill resolver
4. [[plans/01-noodle-extensible-skill-layering/phase-04-ndjson-pipeline]] — NDJSON pipeline (stamp + parse)
5. [[phase-05-event-log]] — Event log + tickets
6. [[plans/01-noodle-extensible-skill-layering/phase-06-spawner]] — Spawner
7. [[plans/01-noodle-extensible-skill-layering/phase-07-monitor]] — Monitor
8. [[plans/01-noodle-extensible-skill-layering/phase-08-adapters-mise]] — Adapter runner + mise
9. [[plans/01-noodle-extensible-skill-layering/phase-09-scheduling-loop]] — Scheduling loop + recovery
10. [[plans/01-noodle-extensible-skill-layering/phase-10-cli]] — CLI commands
11. [[plans/01-noodle-extensible-skill-layering/phase-11-default-skills]] — Default skills + adapters
12. [[plans/01-noodle-extensible-skill-layering/phase-12-debate]] — Debate system
13. [[plans/01-noodle-extensible-skill-layering/phase-13-tui]] — TUI
14. [[plans/01-noodle-extensible-skill-layering/phase-14-bootstrap-readme]] — Bootstrap + README
