...
- [x] ~~[[archive/plans/29-queue-item-context-passthrough/overview]]~~
- [x] ~~[[archive/plans/48-live-agent-steering/overview]]~~
- [x] ~~[[archive/plans/34-failed-target-reset-runtime/overview]]~~ — mostly subsumed by #66
- [ ] [[plans/68-unified-involvement-levels/overview]]
- [ ] [[plans/69-cursor-dispatcher/overview]]
- [ ] [[plans/82-backend-v2-first-principles/overview]]
